package it.quantyca.odm.policyserviceopa.resources.v1.errors;
...
public class ErrorRes {
    ...
    public ErrorRes(int status, PolicyserviceOpaAPIStandardError error, String message, String path) {
        super();
        this.status = status;
